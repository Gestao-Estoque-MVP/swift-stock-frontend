...
const user = {
    ...
    companyDescription:
        'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ut error, quasi animi esse eum nemo rerum vitae ad vel laudantium aliquid amet dolores placeat quae deleniti ex perspiciatis ipsum adipisci?',
    username: 'Elon Musk',
    role: 'admin',
                    ...
                    <div className="flex flex-col w-full md:w-auto max-h-full">
                        <div className="flex gap-[40px]">
                            <div className="relative w-48 h-48 inline-block">
                                ...
                                />
                                <div
                                    className="absolute top-1/2 right-[-27px] transform -translate-y-1/2 bg-[#3026DC] p-2 rounded-full flex items-center"
                                    style={{
                                        padding: '0.9rem',
                                    }}
                                >
                            ...
                            <div className="flex flex-col gap-2 justify-center w-full md:max-w-full w-[450px] ">
                                ...
                                <div className="flex">
                                    <div>
                                        ...
                                        >
                                            <path
                                                d="M10 10.8332C11.9967 10.8332 13.8125 11.4115 15.1483 12.2257C15.815 12.634 16.385 13.1132 16.7967 13.634C17.2017 14.1473 17.5 14.7607 17.5 15.4165C17.5 16.1207 17.1575 16.6757 16.6642 17.0715C16.1975 17.4465 15.5817 17.6948 14.9275 17.8682C13.6125 18.2157 11.8575 18.3332 10 18.3332C8.1425 18.3332 6.3875 18.2165 5.0725 17.8682C4.41833 17.6948 3.8025 17.4465 3.33583 17.0715C2.84167 16.6748 2.5 16.1207 2.5 15.4165C2.5 14.7607 2.79833 14.1473 3.20333 13.634C3.615 13.1132 4.18417 12.634 4.85167 12.2257C6.1875 11.4115 8.00417 10.8332 10 10.8332ZM10 1.6665C11.1051 1.6665 12.1649 2.10549 12.9463 2.88689C13.7277 3.66829 14.1667 4.7281 14.1667 5.83317C14.1667 6.93824 13.7277 7.99805 12.9463 8.77945C12.1649 9.56085 11.1051 9.99984 10 9.99984C8.89493 9.99984 7.83512 9.56085 7.05372 8.77945C6.27232 7.99805 5.83333 6.93824 5.83333 5.83317C5.83333 4.7281 6.27232 3.66829 7.05372 2.88689C7.83512 2.10549 8.89493 1.6665 10 1.6665Z"
                                                fill="#A5A5A5"
                                            />
                                        </svg>
                                    </div>
                                ...
                                <div className="flex gap-1">
                                    ...
                                    <p>Entrou dia {userInputsTexts.user.createdAt}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className=" w-full md:max-w-[420px] mt-24 md:mt-0 max-h-full">
                        <div>
                            <div className="flex gap-12">
                                <img src={user.companyImageUrl} width="100"></img>
                        ...
                        <div>
                            <div className="mt-[59px]">{user.companyDescription}</div>
                        </div>
                        ...
                        <div className="mt-[80px]">
                            ...
                            <div className="mt-[26px]">
                                <Plan
                                    name="Plano Básico"
                                    description="Descrição do plano básico Lorem Ipsum sei la o que"
                                />
                                <Plan
                                    name="Plano Básico"
                                    description="Descrição do plano básico Lorem Ipsum sei la o que"
