...
const Contact = () => {
    return (
        <section id="contact" className="bg-white-primary py-24" data-aos="fade-up">
            <div className="bg-logoPattern bg-cover bg-no-repeat bg-right my-0 mx-auto p-4 w-full max-w-screen-2xl bg-brand-200 py-16 flex flex-col items-center gap-11 md:rounded-3xl md:bg-center ">
                <div className="flex flex-col gap-9">
                    <div className="flex flex-col gap-2">
                        <h1
                            className="text-center font-default-font text-3xl text-white-primary font-extrabold"
                            data-aos="fade-right"
                        >
                            Dúvidas?
                        </h1>
                        <p
                            className="font-deafult-font text-base font-normal text-white-total text-center"
                            data-aos="fade-right"
                        >
                            Entre em contato com o time da Swift Stock
                        </p>
                    </div>
            ...
            <p className="text-base text-brand-500 font-default-font font-normal">+55 99 99999-9999</p>
                        ...
                        <div data-aos="fade-right" className="flex gap-2 items-center">
                            <IoIosCopy
                                title="Copiar email"
                                className="text-white-total cursor-pointer "
                                size={16}
                            />
                            <Link
                                href={'mailto:switftstock@gmail.com'}
                                className="text-base text-brand-500 font-default-font font-normal underline"
                            >
                                switftstock@gmail.com
                            </Link>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4 w-full md:flex-row justify-center md:w-auto">
                    ...
                    <Link
                        data-aos="fade-right"
                        className="flex items-center justify-center py-3 rounded w-full md:w-auto bg-white-primary text-brand-300 font-default-font font-semibold text-base md:px-16"
                        href="mailto:switftstock@gmail.com"
                    >
                        Enviar Email
                    </Link>
