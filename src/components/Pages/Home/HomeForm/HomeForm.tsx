    ...
    return (
        <section id="participate">
            <Container className="flex justify-between items-center my-16">
                <figure
                    data-aos="flip-left"
                    className="hidden md:flex md:w-[40%] md:justify-center md:items-center"
                >
                    <Image
                        className="w-full h-full object-cover"
                        src={logoIcon}
                        alt="Swift Stock logo"
                    />
                </figure>
                ...
                <div className="w-full md:w-[40%]">
                    <header className="flex flex-col gap-3 mb-9">
                        <h3
                            data-aos="fade-right"
                            className="font-extrabold text-2xl text-brand-200"
                        >
                            Em breve!
                        </h3>
                        <p data-aos="fade-right" className="text-grey-300 text-xs">
                            Nossos desenvolvedores estão empenhados em entregar uma ótima
                            experiência para você! Preencha o formulário abaixo e seja notificado(a)
                    ...
                    <form
                        ...
                        className="flex flex-col gap-6 text-brand-200 font-semibold"
                    >
                        <input
                            data-aos="zoom-in-up"
                            className="py-2 px-4 outline-none rounded-md placeholder:text-grey-200 placeholder:font-medium"
                        ...
                        <div data-aos="zoom-in-up" className="flex items-center gap-3">
                            ...
                            <label
                                ...
                                className="text-grey-300 text-xs font-normal"
                            >
                        ...
                        <Button
                            aos="zoom-in-up"
                            type="submit"
                            className="mt-6 max-w-full rounded-md"
                        >
