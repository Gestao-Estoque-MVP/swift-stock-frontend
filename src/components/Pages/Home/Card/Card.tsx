...
const Card = ({ data, type, children }: ICardProps) => {
    return (
        <li
            ...
            data-aos-offset="100"
            key={data.id}
            className="flex flex-col flex-1 gap-6 bg-white-primary rounded-lg	py-4 px-6 min-w-card max-w-md md:max-w-xs md:flex-none"
        >
            <div className="flex gap-3 items-center">
                <div className="rounded-full border-grey-100 border p-1">{children}</div>
