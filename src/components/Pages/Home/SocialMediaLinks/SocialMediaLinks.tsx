    ...
    return (
        <div className="flex justify-center md:justify-end items-center gap-6">
            <Link
                target="_blank"
                href=""
                className="transition-all ease-in duration-75 hover:-translate-y-1"
            >
            ...
            <Link
                target="_blank"
                href="https://www.linkedin.com/in/swift-stock-3a2403286/"
                className="transition-all ease-in duration-75 hover:-translate-y-1"
            >
            ...
            <Link
                target="_blank"
                href="https://www.instagram.com/switftstock"
                className="transition-all ease-in duration-75 hover:-translate-y-1"
            >
