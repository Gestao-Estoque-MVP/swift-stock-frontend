...
const Footer = () => {
    return (
        <footer className="bottom-0 w-screen h-96 bg-brand-400 py-8 bg-[url('../assets/blur.png')] bg-no-repeat lg:bg-cover">
            <Container className="relative  h-full">
                <div className="group w-100 flex justify-center -translate-y-16">
                    <Link href="#top">
                        <Button data-aos="fade-up" className="max-w-xs rounded-3xl">
                            Voltar para o topo
                ...
                <div className="flex flex-col justify-between  h-full">
                    ...
                    <div className="flex flex-col text-center md:text-left md:items-center md:flex-row flex-wrap justify-between items-center mb-5">
                        <p className="max-w-2xl mb-3 text-white-primary text-xs">
                            Avançando juntos rumo ao futuro do gerenciamento de estoque -
                            simplificado, eficiente e libertador
                        </p>
