...
export const Table = ({ itens }: TableProps) => {
    ...
    const columns = useMemo<MRT_ColumnDef<ITable>[]>(
        () => [
            {
                header: 'Nome',
                accessorFn: (row: ITable) => ({
                    imageUrl: row.imageUrl,
                    name: row.name,
                }),
                Cell: (value) => {
                    const data = value?.renderedCellValue as unknown as {
                        imageUrl: string;
                        name: string;
                    };
                    return (
            ...
            },
            {
                ...
                Cell: (value) => (
                    <>
                        <ProductStatus state={(value?.renderedCellValue as StateKeys) || ''}>
    ...
    const element = (
        <div ref={elementRef} className="max-w-full">
            <p
                className="ml-[18px] text-3xl font-late"
                style={{ color: 'var(--black, #202020)', fontWeight: '600' }}
            >
                Lista de produtos
            </p>
            <MaterialReactTable
                ...
                icons={{
                    ...
                    SortIcon: () => (
                        ...
                        >
                            <path
                                d="M0.578696 1.68394C-0.0200533 1.04528 0.432792 0 1.30823 0H11.6918C12.5672 0 13.0201 1.04528 12.4213 1.68394L7.22954 7.22183C6.83446 7.64324 6.16554 7.64324 5.77046 7.22183L0.578696 1.68394Z"
                                fill="#A5A5A5"
                            />
                        </svg>
                    ),
