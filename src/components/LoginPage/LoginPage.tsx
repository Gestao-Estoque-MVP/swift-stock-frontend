...
const LoginPage = () => {
  ...
  return (
      <FormPage>
        <section className='bg-white-primary w-full py-12 px-6  sm:rounded-xl max-w-lg mx-5'>
          <header className='flex flex-col items-center gap-5 mb-10'>
            <Image src={logoBlue} alt='Logo SwiftStock'/>
            <p className='font-default-font text-grey-100 text-sm text-center'>Lorem ipsum dolor amet lorem ipsum</p>
          </header>
