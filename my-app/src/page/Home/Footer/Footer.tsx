...
const Footer = () => {
    return(
        <footer className="bottom-0 w-screen h-96 bg-brand-400 py-8 bg-[url('/avatar/blur.png')] bg-no-repeat lg:bg-cover">
                ...
                <div className="flex flex-col justify-between  h-full">
                    <div className="flex flex-col md:flex-row flex-wrap justify-between items-center gap-6">
                        <Link href="" data-aos="fade-right"> 
                            <Image width={75}
                height={75} alt="Logo da SwiftStock" src="/avatar/logo-white.svg" width={75}
                height={75}/>
                        </Link>
