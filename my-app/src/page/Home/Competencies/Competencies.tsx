...
import dataCard from '@/page/Home/Competencies/competenciesInfos.json';
...
const Competencies = () => {
  ...
  return (
    <section id="advantages" className={`bg-brand-400 py-11 pt-20 relative bg-[url('/avatar/blur.png')] bg-no-repeat bg-cover transition-all duration-300 ${!seeMore ? 'max-h-mobile md:max-h-desktop overflow-hidden' : 'h-fit'}  after:content-[""] after:w-full after:h-80 after:absolute after:bottom-0 after:z-10 after:bg-gradient-to-t from-brand-400 ...`}>
